...
import me.badbones69.crazycrates.multisupport.nms.v1_17_R1.StructureService;
        ...
        for (int x = 0; x < areas[0]; x++) {
            for (int y = 0; y < areas[1]; y++) {
                for (int z = 0; z < areas[2]; z++) {
                    ...
                    structures[StructureService.getYzxIndex(x, y, z, areas[0], areas[2])].a(world, pos, pos, structInfo, random, z);
                }
            }
        }
    }
